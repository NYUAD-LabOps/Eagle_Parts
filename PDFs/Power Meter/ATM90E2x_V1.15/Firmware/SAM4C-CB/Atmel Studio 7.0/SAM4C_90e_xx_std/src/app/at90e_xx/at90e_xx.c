...
{
	pmc_enable_periph_clk( AFE_PM0_ID );
	pmc_enable_periph_clk( AFE_PM1_ID );
	AFE_PM1_PIO_En();
	AFE_PM0_PIO_En();
	AFE_PM0_Out();
	AFE_PM1_Out();	
...
void	AFE_Configure_ZX0(void)
{
	...
	AFE_ZX0_PIO_En();
	AFE_ZX0_PullUp_En();
	AFE_ZX0_PIO->PIO_IFER |= AFE_ZX0_MASK;
	//AFE_ZX0_PIO->PIO_SCDR =20;
	AFE_ZX0_PIO->PIO_IFSCER |= AFE_ZX0_MASK;
	
	//pio_handler_set(AFE_ZX0_PIO, AFE_ZX0_ID, AFE_ZX0_MASK, AFE_ZX0_ATR, AFE_ZX0_INT_handler);
    pio_enable_interrupt(AFE_ZX0_PIO, AFE_ZX0_MASK);
	
	VAFE.IntNum[ZX0] =0;
	
    NVIC_DisableIRQ(AFE_ZX0_IRQn);
    NVIC_ClearPendingIRQ(AFE_ZX0_IRQn);
    NVIC_SetPriority(AFE_ZX0_IRQn, 0);
    NVIC_EnableIRQ(AFE_ZX0_IRQn);
}
//=========================================================
...
void	AFE_Configure_ZX1(void)
{
	...
	AFE_ZX1_PIO_En();
	AFE_ZX1_PullUp_En();
	AFE_ZX1_PIO->PIO_IFER |= AFE_ZX1_MASK;
	//AFE_ZX1_PIO->PIO_SCDR =20;
	AFE_ZX1_PIO->PIO_IFSCER |= AFE_ZX1_MASK;
	
	//pio_handler_set(AFE_ZX1_PIO, AFE_ZX1_ID, AFE_ZX1_MASK, AFE_ZX1_ATR, AFE_ZX1_INT_handler);
    pio_enable_interrupt(AFE_ZX1_PIO, AFE_ZX1_MASK);
	
	VAFE.IntNum[ZX1] =0;
	
    NVIC_DisableIRQ(AFE_ZX1_IRQn);
    NVIC_ClearPendingIRQ(AFE_ZX1_IRQn);
    NVIC_SetPriority(AFE_ZX1_IRQn, 0);
    NVIC_EnableIRQ(AFE_ZX1_IRQn); 
}
//=========================================================
...
void	AFE_Configure_ZX2(void)
{
	...
	AFE_ZX2_PIO_En();
	AFE_ZX2_PullUp_En();
	AFE_ZX2_PIO->PIO_IFER |= AFE_ZX2_MASK;
	//AFE_ZX2_PIO->PIO_SCDR =20;
	AFE_ZX2_PIO->PIO_IFSCER |= AFE_ZX2_MASK;
	
	pio_handler_set(AFE_ZX2_PIO, AFE_ZX2_ID, AFE_ZX2_MASK, AFE_ZX2_ATR, AFE_ZX2_INT_handler);
    pio_enable_interrupt(AFE_ZX2_PIO, AFE_ZX2_MASK);
	
	VAFE.IntNum[ZX2] =0;
	
    NVIC_DisableIRQ(AFE_ZX2_IRQn);
    NVIC_ClearPendingIRQ(AFE_ZX2_IRQn);
    NVIC_SetPriority(AFE_ZX2_IRQn, 0);
    NVIC_EnableIRQ(AFE_ZX2_IRQn); 
}
//=========================================================
...
void	AFE_Configure_CF1(void)
{
	...
	AFE_CF1_PIO_En();
	AFE_CF1_PullUp_En();
	AFE_CF1_PIO->PIO_IFER |= AFE_CF1_MASK;
	//AFE_CF1_PIO->PIO_SCDR =20;
	AFE_CF1_PIO->PIO_IFSCER |= AFE_CF1_MASK;
	
	pio_handler_set(AFE_CF1_PIO, AFE_CF1_ID, AFE_CF1_MASK, AFE_CF1_ATR, AFE_CF1_INT_handler);
    pio_enable_interrupt(AFE_CF1_PIO, AFE_CF1_MASK);
	
	VAFE.IntNum[CF1] =0;
	
    NVIC_DisableIRQ(AFE_CF1_IRQn);
    NVIC_ClearPendingIRQ(AFE_CF1_IRQn);
    NVIC_SetPriority(AFE_CF1_IRQn, 0);
    NVIC_EnableIRQ(AFE_CF1_IRQn);
}
//=========================================================
...
void	AFE_Configure_CF2(void)
{
	...
	AFE_CF2_PIO_En();
	AFE_CF2_PullUp_En();
	AFE_CF2_PIO->PIO_IFER |= AFE_CF2_MASK;
	//AFE_CF2_PIO->PIO_SCDR =20;
	AFE_CF2_PIO->PIO_IFSCER |= AFE_CF2_MASK;
	
	pio_handler_set(AFE_CF2_PIO, AFE_CF2_ID, AFE_CF2_MASK, AFE_CF2_ATR, AFE_CF2_INT_handler);
    pio_enable_interrupt(AFE_CF2_PIO, AFE_CF2_MASK);
	
	VAFE.IntNum[CF2] =0;
	
    NVIC_DisableIRQ(AFE_CF2_IRQn);
    NVIC_ClearPendingIRQ(AFE_CF2_IRQn);
    NVIC_SetPriority(AFE_CF2_IRQn, 0);
    NVIC_EnableIRQ(AFE_CF2_IRQn);
}
//=========================================================
...
void	AFE_Configure_CF3(void)
{
	...
	AFE_CF3_PIO_En();
	AFE_CF3_PullUp_En();
	AFE_CF3_PIO->PIO_IFER |= AFE_CF3_MASK;
	//AFE_CF3_PIO->PIO_SCDR =20;
	AFE_CF3_PIO->PIO_IFSCER |= AFE_CF3_MASK;
	
	pio_handler_set(AFE_CF3_PIO, AFE_CF3_ID, AFE_CF3_MASK, AFE_CF3_ATR, AFE_CF3_INT_handler);
    pio_enable_interrupt(AFE_CF3_PIO, AFE_CF3_MASK);
	
	VAFE.IntNum[CF3] =0;
	
    NVIC_DisableIRQ(AFE_CF3_IRQn);
    NVIC_ClearPendingIRQ(AFE_CF3_IRQn);
    NVIC_SetPriority(AFE_CF3_IRQn, 0);
    NVIC_EnableIRQ(AFE_CF3_IRQn);
}
//=========================================================
...
void	AFE_Configure_CF4(void)
{
	...
	AFE_CF4_PIO_En();
	AFE_CF4_PullUp_En();
	AFE_CF4_PIO->PIO_IFER |= AFE_CF4_MASK;
	//AFE_CF4_PIO->PIO_SCDR =20;
	AFE_CF4_PIO->PIO_IFSCER |= AFE_CF4_MASK;
	
	pio_handler_set(AFE_CF4_PIO, AFE_CF4_ID, AFE_CF4_MASK, AFE_CF4_ATR, AFE_CF4_INT_handler);
    pio_enable_interrupt(AFE_CF4_PIO, AFE_CF4_MASK);
	
	VAFE.IntNum[CF4] =0;
	
    NVIC_DisableIRQ(AFE_CF4_IRQn);
    NVIC_ClearPendingIRQ(AFE_CF4_IRQn);
    NVIC_SetPriority(AFE_CF4_IRQn, 0);
    NVIC_EnableIRQ(AFE_CF4_IRQn); 
}
//=========================================================
...
void	AFE_Configure_IRQ0(void)
{
	...
	AFE_IRQ0_PIO_En();
	AFE_IRQ0_PullUp_En();
	AFE_IRQ0_PIO->PIO_IFER |= AFE_IRQ0_MASK;
	//AFE_IRQ0_PIO->PIO_SCDR =20;
	AFE_IRQ0_PIO->PIO_IFSCER |= AFE_IRQ0_MASK;
	
	//pio_handler_set(AFE_IRQ0_PIO, AFE_IRQ0_ID, AFE_IRQ0_MASK, AFE_IRQ0_ATR, AFE_IRQ0_INT_handler);
    //pio_enable_interrupt(AFE_IRQ0_PIO, AFE_IRQ0_MASK);
	
    //NVIC_DisableIRQ(AFE_IRQ0_IRQn);
    //NVIC_ClearPendingIRQ(AFE_IRQ0_IRQn);
    //NVIC_SetPriority(AFE_IRQ0_IRQn, 0);
    //NVIC_EnableIRQ(AFE_IRQ0_IRQn); 
}
//=========================================================
//decription	::	AFE configure IRQ1
//function		::	AFE_Configure_IRQ1
...
void	AFE_Configure_IRQ1(void)
{
	...
	AFE_IRQ1_PIO_En();
	AFE_IRQ1_PullUp_En();
	AFE_IRQ1_PIO->PIO_IFER |= AFE_IRQ1_MASK;
	//AFE_IRQ1_PIO->PIO_SCDR =20;
	AFE_IRQ1_PIO->PIO_IFSCER |= AFE_IRQ1_MASK;
}
//=========================================================
...
void	AFE_Configure_WarmOut(void)
{
	...
	AFE_WARMOUT_PIO_En();
	AFE_IRQ1_PullUp_En();
	AFE_WARMOUT_PIO->PIO_IFER |= AFE_WARMOUT_MASK;
	//AFE_WARMOUT_PIO->PIO_SCDR =20;
	AFE_WARMOUT_PIO->PIO_IFSCER |= AFE_WARMOUT_MASK;
}
//=========================================================
