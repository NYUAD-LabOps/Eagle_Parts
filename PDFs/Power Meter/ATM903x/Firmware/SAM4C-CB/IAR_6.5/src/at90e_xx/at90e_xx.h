...
//------AFE ZX0--------------
#define AFE_ZX0_PIN   	(PIO_PA13_IDX)
#define AFE_ZX0_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

#define AFE_ZX0_MASK 	(PIO_PA13)
#define AFE_ZX0_PIO 	PIOA
#define AFE_ZX0_ID 		ID_PIOA
#define AFE_ZX0_TYPE 	PIO_INPUT
#define AFE_ZX0_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE ZX1--------------
#define AFE_ZX1_PIN   	(PIO_PA18_IDX)
#define AFE_ZX1_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

#define AFE_ZX1_MASK 	(PIO_PA18)
#define AFE_ZX1_PIO 	PIOA
#define AFE_ZX1_ID 		ID_PIOA
#define AFE_ZX1_TYPE 	PIO_INPUT
#define AFE_ZX1_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE ZX2--------------
#define AFE_ZX2_PIN   	(PIO_PA16_IDX)
#define AFE_ZX2_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_ZX2_MASK 	(PIO_PA16)
#define AFE_ZX2_PIO 	PIOA
#define AFE_ZX2_ID 		ID_PIOA
#define AFE_ZX2_TYPE 	PIO_INPUT
#define AFE_ZX2_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE CF1--------------
#define AFE_CF1_PIN   	(PIO_PA20_IDX)
#define AFE_CF1_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_CF1_MASK 	(PIO_PA20)
#define AFE_CF1_PIO 	PIOA
#define AFE_CF1_ID 		ID_PIOA
#define AFE_CF1_TYPE 	PIO_INPUT
#define AFE_CF1_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE CF2--------------
#define AFE_CF2_PIN   	(PIO_PA19_IDX)
#define AFE_CF2_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_CF2_MASK 	(PIO_PA19)
#define AFE_CF2_PIO 	PIOA
#define AFE_CF2_ID 		ID_PIOA
#define AFE_CF2_TYPE 	PIO_INPUT
#define AFE_CF2_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE CF3--------------
#define AFE_CF3_PIN   	(PIO_PA27_IDX)
#define AFE_CF3_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_CF3_MASK 	(PIO_PA27)
#define AFE_CF3_PIO 	PIOA
#define AFE_CF3_ID 		ID_PIOA
#define AFE_CF3_TYPE 	PIO_INPUT
#define AFE_CF3_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
//------AFE CF4--------------
#define AFE_CF4_PIN   	(PIO_PA26_IDX)
#define AFE_CF4_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_CF4_MASK 	(PIO_PA26)
#define AFE_CF4_PIO 	PIOA
#define AFE_CF4_ID 		ID_PIOA
#define AFE_CF4_TYPE 	PIO_INPUT
#define AFE_CF4_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

//------AFE IRQ0--------------
#define AFE_IRQ0_PIN   	(PIO_PA28_IDX)
#define AFE_IRQ0_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_IRQ0_MASK 	(PIO_PA28)
#define AFE_IRQ0_PIO 	PIOA
#define AFE_IRQ0_ID 	ID_PIOA
#define AFE_IRQ0_TYPE 	PIO_INPUT
#define AFE_IRQ0_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

#define	BIO_AFE_IRQ0		PIOA->PIO_PDSR & (AFE_IRQ0_MASK)

//------AFE IRQ1--------------
#define AFE_IRQ1_PIN   	(PIO_PB7_IDX)
#define AFE_IRQ1_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_IRQ1_MASK 	(PIO_PB7)
#define AFE_IRQ1_PIO 	PIOB
#define AFE_IRQ1_ID 	ID_PIOB
#define AFE_IRQ1_TYPE 	PIO_INPUT
#define AFE_IRQ1_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

#define	BIO_AFE_IRQ1		PIOB->PIO_PDSR & (AFE_IRQ1_MASK)

//------AFE WARMOUT--------------
#define AFE_WARMOUT_PIN   	(PIO_PA29_IDX)
#define AFE_WARMOUT_FLAGS    (PIO_INPUT | PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)
#define AFE_WARMOUT_MASK 	(PIO_PA29)
#define AFE_WARMOUT_PIO 	PIOA
#define AFE_WARMOUT_ID 		ID_PIOA
#define AFE_WARMOUT_TYPE 	PIO_INPUT
#define AFE_WARMOUT_ATTR 	(PIO_PULLUP | PIO_DEBOUNCE | PIO_IT_FALL_EDGE)

#define	BIO_AFE_WARMOUT		PIOA->PIO_PDSR & (AFE_WARMOUT_MASK)

//-----------------------------------------------
#define	AFE_RST_PORT		(IOPORT_PIOB)
#define	AFE_RST_MASK		((1<<10))
#define	AFE_RST_PIN			PIO_PB10_IDX
#define	AFE_DMA_PORT		(IOPORT_PIOB)
#define	AFE_DMA_MASK		((1<<8))
#define	AFE_DMA_PIN			PIO_PB8_IDX
#define	AFE_PM1_PORT		(IOPORT_PIOB)
#define	AFE_PM1_MASK		((1<<9))
#define	AFE_PM1_PIN			PIO_PB9_IDX
#define	AFE_PM0_PORT		(IOPORT_PIOB)
#define	AFE_PM0_MASK		((1<<6))
#define	AFE_PM0_PIN			PIO_PB6_IDX

#define	AFE_RST_Out()	PIOB->PIO_OER |=AFE_RST_MASK//arch_ioport_set_pin_dir(AFE_RST_PIN,IOPORT_DIR_OUTPUT)
#define	AFE_RST_In()	PIOB->PIO_ODR |=AFE_RST_MASK//arch_ioport_set_pin_dir(AFE_RST_PIN,IOPORT_DIR_INPUT)
#define	AFE_DMA_Out()	PIOB->PIO_OER |=AFE_DMA_MASK//arch_ioport_set_pin_dir(AFE_DMA_PIN,IOPORT_DIR_OUTPUT)
#define	AFE_DMA_In()	PIOB->PIO_ODR |=AFE_DMA_MASK//arch_ioport_set_pin_dir(AFE_DMA_PIN,IOPORT_DIR_INPUT)
#define	AFE_PM1_Out()	PIOB->PIO_OER |=AFE_PM1_MASK//arch_ioport_set_pin_dir(AFE_PM1_PIN,IOPORT_DIR_OUTPUT)
#define	AFE_PM1_In()	PIOB->PIO_ODR |=AFE_PM1_MASK//arch_ioport_set_pin_dir(AFE_PM1_PIN,IOPORT_DIR_INPUT)
#define	AFE_PM0_Out()	PIOB->PIO_OER |=AFE_PM0_MASK//arch_ioport_set_pin_dir(AFE_PM0_PIN,IOPORT_DIR_OUTPUT)
#define	AFE_PM0_In()	PIOB->PIO_ODR |=AFE_PM0_MASK//arch_ioport_set_pin_dir(AFE_PM0_PIN,IOPORT_DIR_INPUT)  

#define	AFE_RST_High()	PIOB->PIO_SODR |=AFE_RST_MASK// arch_ioport_set_pin_level(AFE_RST_PIN,IOPORT_PIN_LEVEL_HIGH)
#define	AFE_RST_Low()	PIOB->PIO_CODR |=AFE_RST_MASK// arch_ioport_set_pin_level(AFE_RST_PIN,IOPORT_PIN_LEVEL_LOW)
#define	AFE_DMA_High()	PIOB->PIO_SODR |=AFE_DMA_MASK//arch_ioport_set_pin_level(AFE_DMA_PIN,IOPORT_PIN_LEVEL_HIGH)
#define	AFE_DMA_Low()	PIOB->PIO_CODR |=AFE_DMA_MASK//arch_ioport_set_pin_level(AFE_DMA_PIN,IOPORT_PIN_LEVEL_LOW)
#define	AFE_PM1_High()	PIOB->PIO_SODR |=AFE_PM1_MASK//arch_ioport_set_pin_level(AFE_PM1_PIN,IOPORT_PIN_LEVEL_HIGH)
#define	AFE_PM1_Low()	PIOB->PIO_CODR |=AFE_PM1_MASK//arch_ioport_set_pin_level(AFE_PM1_PIN,IOPORT_PIN_LEVEL_LOW)
#define	AFE_PM0_High()	PIOB->PIO_SODR |=AFE_PM0_MASK//arch_ioport_set_pin_level(AFE_PM0_PIN,IOPORT_PIN_LEVEL_HIGH)
#define	AFE_PM0_Low()	PIOB->PIO_CODR |=AFE_PM0_MASK//arch_ioport_set_pin_level(AFE_PM0_PIN,IOPORT_PIN_LEVEL_LOW)

#define	AFE_CS_PORT			(IOPORT_PIOC)
#define	AFE_CS_MASK			((1<<2))
#define	AFE_CS_PIN			2
#define	AFE_SCK_PORT		(IOPORT_PIOC)
#define	AFE_SCK_MASK		((1<<5))
#define	AFE_SCK_PIN			5
#define	AFE_MOSI_PORT		(IOPORT_PIOC)
#define	AFE_MOSI_MASK		((1<<4))
#define	AFE_MOSI_PIN		4
#define	AFE_MISO_PORT		(IOPORT_PIOC)
#define	AFE_MISO_MASK		((1<<3))
#define	AFE_MISO_PIN		3
